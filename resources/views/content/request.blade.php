                ...
                <div class="modal-body bg-body-tertiary">
                    <div class="row mb-3">
                        <div class="col-sm-12 col-md-6">
                            ...
                            <select class="form-select" name="ReqCatSelect" id="requestCategorySelect">
                        ...
                        <div class="col-sm-12 col-md-6 d-none" id="requestDetailsContainer">
                            ...
                            <select class="form-select" name="ReqDetSelect" id="requestDetailSelect">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-12 col-md-6">
                            ...
                            <input type="text" id="TicketNo" name="TicketText" class="form-control" required>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <label for="dateNeeded" class="form-label">Date Needed</label>
                            <input type="date" name="DateNeeded" id="dateNeeded" class="form-control" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-sm-12 col-md-12">
                            <label for="DetailedDesc" class="form-label">Detailed Description of Request</label>
                            <textarea name="DetailedDescription" rows="5" id="DetailedDesc" class="form-control"
