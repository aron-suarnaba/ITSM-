            ...
            <h1 class="navbar-brand navbar-brand-autodark">
                <a href="#" class="d-flex justify-content-center align-items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" style="width: 2.5rem; height: 2.5rem;" viewBox="0 0 24 24"
                        ...
                        stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-devices-pc">
            ...
            <ul class="navbar-nav pt-lg-3">
                <li class="nav-item">
                    <a class="nav-link" href="./">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            class="icon icon-tabler icons-tabler-outline icon-tabler-home me-2">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-person-standing me-2" viewBox="0 0 16 16">
                            <path
                        ...
                        <span class="nav-link-title"> Change Management </span>
                    </a>
                </li>
                <li class="nav-item d-flex align-items-center justify-content-center">
                    <a class="nav-link" href="#">
                        ...
                        <span class="nav-link-title"> Asset & Configuration Database </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="currentColor"
                            class="bi bi-receipt me-2" viewBox="0 0 16 16">
                            <path
                        ...
                        <span class="nav-link-title"> Service Catalog & Workflow Engine </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        ...
                        <span class="nav-link-title"> Knowledge Base & Documentation </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        ...
                        <span class="nav-link-title"> Dashboard & SLA Tracking </span>
                    </a>
                </li>
            </ul>
        </div>
