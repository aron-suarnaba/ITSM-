...
<script type="text/javascript" crossorigin="anonymous" src="/eat/static/dead-clicks-autocapture.js?v=1.297.0"></script>
<script type="text/javascript" crossorigin="anonymous" src="/eat/static/exception-autocapture.js?v=1.297.0"></script>
<script type="text/javascript" crossorigin="anonymous" src="/eat/static/surveys.js?v=1.297.0"></script>
<script type="text/javascript" crossorigin="anonymous"
    src="/eat/array/phc_Ui9ZadLvY1XWtP5iiD3LWDZoXAGYsz6yNvTAvE7wSwn/config.js"></script>
<script type="text/javascript" crossorigin="anonymous" src="/eat/static/dead-clicks-autocapture.js?v=1.297.0"></script>
<script type="text/javascript" crossorigin="anonymous" src="/eat/static/dead-clicks-autocapture.js?v=1.297.0"></script>
<script type="text/javascript" crossorigin="anonymous" src="/eat/static/exception-autocapture.js?v=1.297.0"></script>
<script type="text/javascript" crossorigin="anonymous" src="/eat/static/exception-autocapture.js?v=1.297.0"></script>
<script src="../dist/js/tabler-theme.min.js?1759774800"
    integrity="sha384-SoDJmj40r6f9Rfxi6Fq+bNS8ofhlZMyxHk9dq9Y8e1M17PZGkBRN/XUpx8swn0i5"></script>
...
<header class="hero pb-0">
    <div class="container">
        ...
        <p class="hero-description mt-4">
            Tabler is a free and open source web application UI kit based on Bootstrap&nbsp;5, with hundreds
            responsive components and multiple layouts.
        </p>
        <div class="my-5">
            ...
            <div class="browser">
                <div class="browser-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-8">
                            <a href="https://preview.tabler.io" class="browser-input" target="_blank"
                                rel="noopener noreferrer" data-bs-toggle="tooltip" data-bs-placement="top"
                                data-bs-original-title="Open preview of Tabler dashboard!">
                                ...
                                https://www.ITSM.com.ph
                            </a>
                        </div>
                    </div>
                </div>
                <picture>
                    <img src="../static/marketing/preview.png"
                        srcset="../static/marketing/preview.png 1x, ../static/marketing/preview@2x.png 2x" alt=""
                        class="img-fluid" width="1040" height="760" loading="lazy">
                </picture>
            </div>
        </div>
    </div>
</header>
<section class="section section-light mt-n12 pt-12">
    ...
    <div class="container">
        ...
        <div class="row g-lg-10">
            <div class="col-lg-6 mb-3 mb-lg-0">
                <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" width="500" height="400"
                    viewBox="0 0 500 400" fill="transparent" stroke="var(--tblr-border-color, #b8cef1)"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <p class="text-secondary m-0">
                                    Tabler is fully responsive and compatible with all modern browsers. Thanks to
                                    its modern, user-friendly design you can create a fully
                                    functional interface that users will love. Every UI element has been created
                                    with attention to detail to make your interface beautiful!
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <p class="text-secondary m-0">
                                    ...
                                    speed up the development process and keep your code clean.
                                    Based on Bootstrap 5, Tabler is a cutting-edge solution, compatible with all
                    ...
                    <div>
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <p class="text-secondary m-0">
                                    You can easily customize the UI elements to make them fit the needs of your
                                    project. And don’t worry if you don’t have much experience -
                                    Tabler is easy to get started!
                                </p>
                            </div>
                        </div>
                    </div>
...
<section class="section">
    <div class="container-narrow text-center">
        ...
        <p class="text-secondary">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt, ipsa? Voluptates sunt, ipsum esse quis
            obcaecati atque placeat consectetur beatae,
            tenetur ducimus iure minima expedita recusandae doloribus nam. Pariatur, facilis?
        </p>
        <div class="btn-list justify-content-center mt-6">
            <a href="#" class="btn btn-primary btn-2"> Get started </a>
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-auto"><span class="avatar avatar-md"
                                            style="background-image: url(../static/avatars/052f.jpg)"> </span></div>
                                    <div class="col">
                                ...
                                <p>
                                    ...
                                    significantly smoother. Its intuitive interface is a breath of fresh
                                    air!
                                </p>
                            </div>
                        </a>
                    ...
                    <div class="col-12">
                        <a href="#" class="card bg-surface-secondary">
                            <div class="card-body">
                                ...
                                <p>
                                    I'm beyond impressed with Tabler. This UI kit has transformed my workflow for
                                    the better. It's easy to use, streamlined, and remarkably
                                    efficient.
                                </p>
                            </div>
                        </a>
                    ...
                    <div class="col-12">
                        <a href="#" class="card bg-surface-secondary">
                            <div class="card-body">
                                ...
                                <p>
                                    Tabler's feature-rich package has drastically improved my website design
                                    process. It's an absolute game-changer in the UI kit landscape.
                                </p>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-12">
                        <a href="#" class="card bg-surface-secondary">
                            <div class="card-body">
                                ...
                                <p>
                                    Having used many UI kits in the past, I can confidently say that Tabler stands
                    ...
                    <div class="col-12">
                        <a href="#" class="card bg-surface-secondary">
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-auto"><span class="avatar avatar-md"
                                            style="background-image: url(../static/avatars/001f.jpg)"> </span></div>
                                    <div class="col">
                                        <h3 class="h3 m-0">Maryjo Lebarree</h3>
                                        <div class="text-secondary">Civil Engineer</div>
                                    </div>
                                </div>
                                <p>What I love about Tabler is its sleek design and ease of use. It's really
                                    simplified my HTML designing work. Five stars from me!</p>
                            </div>
                        </a>
                    </div>
                    <div class="col-12">
                        <a href="#" class="card bg-surface-secondary">
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-auto"><span class="avatar avatar-md"
                                            style="background-image: url(../static/avatars/004m.jpg)"> </span></div>
                                    <div class="col">
                                ...
                                <p>
                                    I'd recommend Tabler to anyone, whether they're a seasoned pro or a beginner in
                                    HTML design. Its versatility and user-friendly nature make
                    ...
                    <div class="col-12">
                        <a href="#" class="card bg-surface-secondary">
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-auto"><span class="avatar avatar-md"
                                            style="background-image: url(../static/avatars/002f.jpg)"> </span></div>
                                    <div class="col">
                                ...
                                <p>
                                    Navigating through Tabler has been a breeze! Its intuitive layout helps me save
                    ...
                    <div class="col-12">
                        <a href="#" class="card bg-surface-secondary">
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-auto"><span class="avatar avatar-md"
                                            style="background-image: url(../static/avatars/003f.jpg)"> </span></div>
                                    <div class="col">
                                ...
                                <p>
                                    With Tabler, designing HTML has never been more straightforward. The kit's sleek
                                    features and functionalities have taken my design work to
                                    new heights.
                                </p>
                            </div>
                        </a>
                    ...
                    <div class="col-12">
                        <a href="#" class="card bg-surface-secondary">
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-auto"><span class="avatar avatar-md"
                                            style="background-image: url(../static/avatars/063m.jpg)"> </span></div>
                                    <div class="col">
                                ...
                                <p>
                                    Tabler has revolutionized the way I approach HTML design. Its array of tools and
                                    efficient interface make it a must-have for any designer.
                                </p>
                            </div>
                        </a>
                    </div>
...
<section class="section">
    <div class="container">
        <div class="section-header mb-6">
            ...
            <p class="section-description">Get daily news on upcoming offers from many suppliers all over the world
            </p>
        </div>
    </div>
        ...
        <div class="row g-xl-6">
            <div class="col-lg-4">
                <div class="section-header text-start sticky-top">
                    ...
                    <p class="section-description">Can’t find the answer you’re looking for? Reach out to our
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <div class="text-secondary">
                            Of course! Tabler is under MIT license, so you can confidently use it in commercial
                            projects. However, remember to include a note that your
                            project uses Tabler.
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div class="text-secondary">
                            Tabler is an HTML template that can be used for any purpose. However, it is not made to
                            be easily installed on WordPress. It will require some
                            effort and enough knowledge of the WordPress script to do so.
                        </div>
                    </div>
                </div>
                <div class="mt-5">
            ...
            <div class="row g-lg-4">
                    ...
                    <div class="row g-lg-4">
                        ...
                        <div class="col-md">
                            ...
                            <ul class="list-unstyled list-separated gap-2">
                                ...
                                <li>
                                    <a href="https://status.tabler.io" class="link-secondary" target="_blank"
                        ...
                        <div class="col-md">
                            ...
                            <ul class="list-unstyled list-separated gap-2">
                                ...
                                <li>
                                    <a href="https://github.com/tabler/tabler" class="link-secondary" target="_blank"
                ...
                <div class="col-lg-4 ml-auto">
                    <div class="text-secondary">
                        ...
                        Tabler and make your dashboard great again. For free!
                    </div>
                </div>
            </div>
            ...
            <div class="row g-lg-4">
                <div class="col-lg-auto text-lg-end order-lg-last">
                    <div class="row justify-center">
                        <div class="col-auto">©<a href="https://codecalm.net" class="link-secondary" target="_blank"
                                rel="noopener noreferrer">codecalm.net</a></div>
                        <div class="col-auto">
...
<script src="../dist/js/tabler.min.js?1759774801" defer=""
    integrity="sha384-pku3birjgGovaJ9ngF7SaxKkF/eYUvBjiMJ+jTtWbNesIj2Rud2K63+4JD7EF4gk"></script>
<!-- END GLOBAL MANDATORY SCRIPTS -->
<!-- BEGIN DEMO SCRIPTS -->
<script src="../preview/js/demo.min.js?1759774801" defer=""></script>
<!-- END DEMO SCRIPTS -->
